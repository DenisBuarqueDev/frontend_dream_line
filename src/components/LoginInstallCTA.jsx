      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-white">{t("loginInstall.title")}</p>
            <p className="text-xs text-slate-400 mt-0.5">
              {t("loginInstall.description")}
            </p>
          </div>
        </div>
        <button
        ...
        >
          {loading ? t("loginInstall.installing") : waiting ? t("loginInstall.preparing") : t("loginInstall.install")}
        </button>
      </div>
    </div>
  );
